...
public class ResultadoAlimentoAcordanteEntrada implements java.io.Serializable {
	...
	public ResultadoAlimentoAcordanteEntrada(double valorImposto, double valorBaseDeCalculo,
			Double percentualCargaLiquida, boolean calcularImposto, boolean simplesNacional, String mensagem,
			String regiaoEmitente, String regiaoDestinatario, String fluxo, String tipoProduto, String categoria) {
